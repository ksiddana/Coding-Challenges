...
Tree.prototype.countLeaves = function () {
  ...
  // Check if the children do not have any children
  ...
  var checkLeavesCount = function(node){
  
    // Check if children exist on each node
    console.log(node);
    ...
    for (var i = 0; i < node.children.length; i++) {
      ...
      checkLeavesCount(child);
    }

  }
  // Recursive call to this
  checkLeavesCount(this);
  // Return call count
  return count;
  // return count;
...
root.children[0].addChild(new Tree(7));
root.children[0].children[0].addChild(new Tree(6));
root.countLeaves(); // 3

console.log("Answer:", root.countLeaves()); // 1