...
Tree.prototype.DFSelect = function(filter) {
  ...
  var recursiveCall = function(currentNode, depth) {

    // console.log(currentNode.children.length, filter)
    ...
    for (var i = 0; i < len; i++) {   
      recursiveCall(currentNode.children[i], depth+1);
    }
    
  } // end of sub routine
  
  recursiveCall(this, 0);
  console.log(result);
  return result;
